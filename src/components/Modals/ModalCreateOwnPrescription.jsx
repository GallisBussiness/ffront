...
import { createOwnPrescription } from '../.././services/PrescriptionService';
...
function ModalCreateOwnPrescription({open,onClose,close,auth}) {
   ...
   const  {mutate} = useMutation((data) => createOwnPrescription(data), {
       onSuccess: (_) => {
           toast.success('Ordonnance crée !!');
...
export default ModalCreateOwnPrescription